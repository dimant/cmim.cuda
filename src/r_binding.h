...
extern "C" {
	...
	BFSCUDA_DLL void r_mifsuk(char** data, int* n, int* p, int* k, int* max_parallelism, double* weights);
	BFSCUDA_DLL void r_mifsmed(char** data, int* n, int* p, int* k, int* max_parallelism, double* weights);
	BFSCUDA_DLL void r_cmifs_exact(char** data, int* n, int* p, int* k, int* max_parallelism, double* infgain, double* weights, double* indices);
}
